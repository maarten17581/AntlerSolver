...
public class GraphTest {
    ...
    public void testMultiEdgeSet() {
        Graph graph = makeTestGraph();
        assertEquals(2, graph.multiEdge.size(), "Multi Edge Set test 1 failed");
        assertTrue(graph.multiEdge.contains(graph.nodes.get(4).neighbors.get(graph.nodes.get(5))), "Multi Edge Set test 2 failed");
        graph.addEdge(3, 6, 1);
        assertEquals(2, graph.multiEdge.size(), "Multi Edge Set test 3 failed");
        ...
        assertEquals(4, graph.multiEdge.size(), "Multi Edge Set test 5 failed");
        ...
        assertEquals(2, graph.multiEdge.size(), "Multi Edge Set test 8 failed");
